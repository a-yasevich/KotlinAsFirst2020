...
class PhoneBook {
     ...
     */
    override fun equals(other: Any?): Boolean = other is PhoneBook && phonesMap == other.phonesMap

    override fun hashCode(): Int = phonesMap.hashCode()
