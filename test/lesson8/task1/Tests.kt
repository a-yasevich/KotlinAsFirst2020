...
class Tests {
    ...
    fun lineBySegment() {
        ...
        assertApproxEquals(Line(Point(0.0, 0.0), 0.0), lineBySegment(Segment(Point(-632.0, 0.0), Point(0.0, 0.0))))
    }
    ...
    fun lineByPoint() {
        ...
        assertApproxEquals(Line(Point(0.0, 0.0), 0.0), lineByPoints(Point(0.0, 0.0), Point(1.0, 0.0)))
    }
